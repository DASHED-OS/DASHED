...
Instructor note:
Corrected the docstring - needs to read If True", not If False:
...
In this project, for the ease of testing, you can hard-code a nested list of tasks at the top of your main program, after the dictionary the_menu. We will refer to it as all_tasks.
...
Next, add the following code to your main program to implement the listing of the tasks - you do not need to change it:
        ...
        if subopt == 'A':
            print_tasks(all_tasks, priority_map)
        elif subopt == 'C':
            print_tasks(all_tasks, priority_map, completed = 'yes')
        elif subopt == 'I':
            print_tasks(all_tasks, priority_map, completed = 'no')
